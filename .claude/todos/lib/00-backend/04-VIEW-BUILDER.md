...
Pure DSL builder. No external lookups. No validation. Just JSON output.

## Files to Create

### 1. packs/ui/lib/ui/views/view_builder.rb
...
The DSL outputs whatever you give it. Frontend validates kinds via component registry.

## Example

```ruby
view do
  translations(en: { views: { title: "Contacts" } })
...
```json
{
  ...
  "elements": [{ "type": "PAGE", "title": "title" }]
}
```

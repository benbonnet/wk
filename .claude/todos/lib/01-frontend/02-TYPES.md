...
Define pure TypeScript interfaces for UISchema and component contracts.

## Files to Create

### 1. packs/ui/app/frontend/lib/types.ts
...
### 2. packs/ui/app/frontend/lib/inventory.json

Copy from source:

```bash
cp /Users/ben/Desktop/2025-CRM-REGTECH/frontend/app/lib/ui/inventory.json \
   packs/ui/app/frontend/lib/inventory.json
```
